...
public class QueueHelperTest {
    ...
    public void testGetPlayingQueueForSelectedPlayableMedia() throws Exception {
        MediaMetadataCompat selectedMusic = provider.getMusicsByCategory("Genre 1").iterator().next();
        ...
        String mediaId = MediaIDHelper.createMediaID(
                ...
                MediaIDHelper.MEDIA_ID_MUSICS_BY_CATEGORY, selectedGenre);
        ...
        for (MediaSessionCompat.QueueItem item : queue) {
            ...
            MediaMetadataCompat metadata = provider.getMediaMetadataCompatFromMusicId(musicId);
