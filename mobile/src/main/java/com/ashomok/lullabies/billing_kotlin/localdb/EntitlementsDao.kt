...
interface EntitlementsDao {
    ...
    fun insert(premium: AdsFreeForever)
    ...
    @Delete
    fun delete(premium: AdsFreeForever)

    /**
     * This is purely for convenience. The clients of this DAO don't have to discriminate among
     * [GasTank] vs [AdsFreeForever] vs [GoldStatus] but can simply send in a list of
